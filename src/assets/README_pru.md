...
You can use any JavaScript framework/library on the front-end such as [Angular](https://angular.io/). You also have complete control over which packages you use to do things like make HTTP requests or style your project.
...
8. Used services and async / await connections to connect API  [REST Countries API](https://restcountries.eu)
